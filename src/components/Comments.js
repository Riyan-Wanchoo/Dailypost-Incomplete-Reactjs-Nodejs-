        ...
        <>
            ...
            <div style={{ width: "700px" }} className="offcanvas offcanvas-end" tabIndex="-1" id="offcanvasRight" aria-labelledby="offcanvasRightLabel">
                <div className="offcanvas-header">
                    <h5 id="offcanvasRightLabel">Comments ({!loading && data[0].length})</h5>
                            ...
                            return (<div className="commentItem" key={element._id}>
                                ...
                                <div className="comment-body">
                                    <div className="comment-sender">
                                        <b>{element.userId}</b>  <span className='text-muted mx-1'>{element.date}</span>
                                    </div>
                                    ...
                                    <div className="addReply" style={{ display: "none" }}>
                                        <div className="addComment">
                                            <div className='addComment-inner'>
                                                <div className="comment-img">
                                                    <img id="img" height="40" width="40" src="https://yt3.ggpht.com/ytc/AKedOLTZQI_RX4LKB2iC0mSVB2pTEOCt5IBwsASJCrcu=s88-c-k-c0x00ffffff-no-rj" />
                            ...
                            document.getElementById(reply.parentId).appendChild(
                                <div className="reply">
                                    <div className="commentItem">
                                        ...
                                        <div className="comment-body">
                                            <div className="comment-sender">
                                                <b>{reply.userId}</b>  <span className='text-muted mx-1'>5 days ago</span>
                                            </div>
                                            <div className="comment mt-1 mb-2">
                                                {reply.comment}
                                            </div>
